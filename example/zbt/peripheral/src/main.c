...
static struct k_work_delayable deferred_work_bt_ready;
...
static void disconnected(struct bt_conn *conn, uint8_t reason)
{
    ...
    // Could not call directly in this context, as conn is not released yet.
    k_work_schedule(&deferred_work_bt_ready, K_MSEC(100));
...
int main(void)
{
    ...
    k_work_init_delayable(&deferred_work_bt_ready, deferred_work);
